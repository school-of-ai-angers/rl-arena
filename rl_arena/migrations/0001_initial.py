# Generated by Django 2.2.5 on 2019-10-19 14:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('environment', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='rl_arena.Environment')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ended_at', models.DateTimeField(blank=True)),
                ('environment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rl_arena.Environment')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('submission', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rl_arena.Submission')),
                ('tournament', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rl_arena.Tournament')),
            ],
        ),
        migrations.AddField(
            model_name='tournament',
            name='submissions',
            field=models.ManyToManyField(through='rl_arena.TournamentSubmission', to='rl_arena.Submission'),
        ),
        migrations.CreateModel(
            name='DuelSubmission',
            fields=[
                ...
                ('duel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rl_arena.Duel')),
                ('submission', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rl_arena.Submission')),
            ],
        ),
        migrations.AddField(
            model_name='duel',
            name='submissions',
            field=models.ManyToManyField(through='rl_arena.DuelSubmission', to='rl_arena.Submission'),
        ),
        migrations.AddField(
            model_name='duel',
            name='tournament',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rl_arena.Tournament'),
        ),
    ]
